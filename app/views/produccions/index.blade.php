		...
		<div class="modal-content">
		    ...
		    <div class="modal-footer">
				<div class="btn-footer">
				    <button class="btn btn-primary" onclick="validar('producciones')" id="btn-save">
				    	<i class='icon-ok'></i>
				    	Guardar
				    </button>
...
<script type="text/javascript">
    ...
    var col_names = ['Item', 'Descripción', 'Cantidad', 'animal', ''];
    var accion = ['delete'];
    loadTable('GET', url+'/getProduccion', url, grid_table, col_names, accion);
	...
	{
	    $('#id_main, #descripcion, #cantidad').val('');
	}
</script>